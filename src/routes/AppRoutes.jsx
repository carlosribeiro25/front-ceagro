...
import PagesProdutos from '../pages/pageProdutos/PagesProdutos'
...
export default function AppRoutes() {
    return (
        <Routes>
            ...
            <Route path='/produtos/deletar' element={
                <PrivateRoute>
                    <Layout>
                    <DeletarProduto/>
                    </Layout>
            ...
            <Route path='/produtos/atualizar' element={
                <PrivateRoute>
                    <Layout>
                     <AtualizarProduto/>
                    </Layout>
             ...
             <Route path='/produtos/pagesProdutos' element={
                <PrivateRoute>
                    <Layout>
                     <PagesProdutos/>
                    </Layout>
