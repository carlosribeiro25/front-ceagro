    ...
    <table className="table-auto border-collapse border border-gray-700 w-full text-sm">
      <thead className="border-collapse border border-gray-700 ">
        <tr>
          ...
          <th className="px-2 py-1 text-sm text-accent text-center border-collapse border border-gray-800">QUANT</th>
          <th className="px-2 py-1 text-sm text-accent text-center border-collapse border border-gray-800">DIV1</th>
          <th className="px-2 py-1 text-sm text-accent text-center border-collapse border border-gray-800">Div2</th>
      ...
      <tbody>
        {produtos?.produtos?.map((produto) => (
          <tr key={produto.id}>
             <td className='px-2 py-1 border-collapse border border-gray-800 text-left'>{produto.name}</td>
             <td className='px-2 py-1 border-collapse border border-gray-800 text-left'>{produto.QNT}</td>
             <td className='px-4 py-1 border-collapse border border-gray-800 text-left'>{produto.D1}</td>
             <td className='px-4 py-1 border-collapse border border-gray-800 text-left'>{produto.D2}</td>
             <td className='px-4 py-1 border-collapse border border-gray-800 text-left'>
              <label>
            <input
            className='h-3 w-3 '
              type="checkbox"
